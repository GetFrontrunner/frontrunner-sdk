...
DEFAULT_FRONTRUNNER_CONFIG: FrontrunnerConfig = ChainedFrontrunnerConfig([
  ...
  StaticFrontrunnerConfig(
    injective_exchange_base_url="https://injective-node-v2-staging.grpc-exchange.getfrontrunner.com",
    injective_grpc_base_url="https://injective-node-v2-staging.grpc.getfrontrunner.com",
    injective_lcd_base_url="https://injective-node-v2-staging.lcd.getfrontrunner.com",
    injective_rpc_base_url="https://injective-node-v2-staging.tm.getfrontrunner.com",

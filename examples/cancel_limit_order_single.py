...
async def run(market_name, order_side, orderhash) -> None:
    ...
    msg = build_msg(composer, address, subaccount_id, market_name, order_side, orderhash)
...
def parse_cli_argments() -> Namespace:
    ...
    parser.add_argument("orderhash", type=float, help="order hash")
...
if __name__ == "__main__":
    ...
    asyncio.get_event_loop().run_until_complete(
        run(namespace.market, namespace.side, namespace.orderhash)
    )

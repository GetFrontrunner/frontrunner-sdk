...
async def run_get_markets(namespace: Namespace, configuration: Configuration, status: Optional[MarketStatus]):
...
async def main():
  ...
  await run_get_markets(namespace, configuration, None)

...
class MarketMaker:
  ...
  def build_buy_orders(self, prices: List[float], quantities: List[int], sides: List[Literal["long",
                                                                                             "short"]]) -> List[Order]:
  ...
  def build_sell_orders(self, prices: List[float], quantities: List[int], sides: List[Literal["long",
                                                                                              "short"]]) -> List[Order]:
  ...
  async def get_my_orders(self):
    return await self.async_inj.get_orders(mine=True)

...
async def run(market_name, order_side, price, quantity) -> None:
    ...
    msg = build_msg(composer, address, subaccount_id, market_name, order_side, price, quantity)
...
def build_msg(
    ...
    # build msg
    binary_options_market_id_create = get_market_id(market_name, order_side)

    binary_options_market_id_cancel = binary_options_market_id_create

    binary_options_market_ids_to_cancel_all = [binary_options_market_id_create]
...
def parse_cli_argments() -> Namespace:
    ...
    parser.add_argument("market", help="ABC-XYZ")
    parser.add_argument("side", help="order side: buy or sell")
    parser.add_argument("price", type=float, help="order price, float")
    parser.add_argument("quantity", type=int, help="order quantity, int")
...
if __name__ == "__main__":
    ...
    print("address: ", fee_recipient)
    asyncio.get_event_loop().run_until_complete(
        run(namespace.market, namespace.side, namespace.price, namespace.quantity)
    )
